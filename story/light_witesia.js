var story_light_witesia = [
  ...
  }, // 100
  {
    ...
    text: [
      ...
      {
        content: ['You wander down the main road of Basinfront.'],
      },
      {
        content: [
        ...
        conditions: (player) =>
          player.time.getHours() >= 6 && player.time.getHours() <= 18,
      },
      {
        content: [
        ...
        norepeat: 104,
        conditions: (player) =>
          player.time.getHours() >= 6 && player.time.getHours() <= 10,
      },
      {
        content: ['The Hunters Guild building is open.'],
        conditions: (player) =>
          player.time.getHours() >= 6 && player.time.getHours() <= 10,
        norepeat: [104, 1, true],
      },
  ...
  }, // 101
  {
    ...
    text: [
      {
        content: ['You try your luck at hitchiking to Timberside.'],
      },
      {
        content: ['Unfortunately nobody stops to offer you a lift.'],
        conditions: (player) => player.random <= 50,
        alternate: ['A passing explorer offers you a lift.'],
      },
    ],
    options: [
      {
  ...
  }, // 105
  {
    ...
    text: [
      {
        content: ['You look at the hunter-related posters on the board.'],
      },
      {
        content: [
  ...
  }, // 106
  {
    ...
    text: [
      {
        content: ['You look at the explorer-related posters on the board.'],
      },
      {
        content: ["There's nothing that catches your eye."],
      },
    ],
    options: [
      {
  ...
  }, // 107
  {
    ...
    text: [
      {
        content: ['You look at the other posters on the board.'],
      },
      {
        content: ["There's not much here, and none of them stand out."],
      },
    ],
    options: [
      {
    ...
    options: [
      {
        ...
        action: function () {
          ...
          if (
            ...
            player.stats.agility.amount >= 5 &&
            player.stats.perception.amount < 5
          )
            player.stats.perception.amount += 1;
          player.gold += 50;
        },
        fatigue: 40,
      },
  ...
  }, // 110
  {
    ...
    text: [
      {
        content: ['You try your luck at hitchiking to Oldwatch'],
      },
      {
        content: ['A passing merchant offers you a lift.'],
        conditions: (player) => player.random > 50,
        alternate: ['Unfortunately nobody stops to offer you a lift.'],
      },
    ],
    options: [
      {
  ...
  }, // 112
  {
    ...
    text: [
      {
        content: ["You're stand in Basinfront's local inn."],
        conditions: (player) =>
          player.previous_scene == 118 || player.previous_scene == 115,
        alternate: ["You enter Basinfront's local inn."],
      },
      {
        content: ['The innkeeper stands at the bar, serving someone a drink.'],
  ...
  }, // 113
  {
    ...
    text: [
      {
        content: ['You walk up to the innkeeper.'],
        conditions: (player) => player.time.getHours() >= 7,
        alternate: ['You walk up to the inn staff.'],
      },
      {
        content: ['"A new face, what can I get you?"'],
        norepeat: true,
        conditions: (player) => player.hometown !== 'Basinfront',
        alternate: ['"What can I get you today?"'],
    ...
    text: [
      {
        ...
        alternate: ["You're in your room at the Basinfront inn."],
      },
    ],
    options: [
      {
    ...
    text: [
      {
        ...
        alternate: ['You stand on the streets of Oldwatch.'],
      },
    ],
    options: [
      {
  ...
  }, // 151
  {
    ...
    text: [
      ...
      {
        content: ['A passing hunter offers you a lift.'],
        conditions: (player) => player.random > 50,
        alternate: ['Unfortunately nobody stops to offer you a lift.'],
      },
    ],
