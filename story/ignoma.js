var story_ignoma = [
  ...
  }, // 0
  {
    ...
    text: [
      ...
      },
      {
        ...
        conditions: (player) =>
          player.time.getHours() >= 7 && player.time.getHours() <= 13,
      },
      {
  ...
  }, // 1
  {
    ...
    text: [
      {
        content: ['You offer to help load and unload cargo on the docks.'],
      },
      {
        content: [
  ...
  }, // 2
  {
    ...
    text: [
      {
        content: ['The hours go by in a flash as you help out on the docks.'],
      },
    ],
    options: [
      {
  ...
  }, // 3
  {
    ...
    text: [
      {
        content: ['You make your way to the local inn.'],
      },
      {
        content: [
  ...
  }, // 4
  {
    ...
    text: [
      ...
      {
        content: ['"The rooms are 10 gold a night." they add.'],
  ...
  }, // 5
  {
    ...
    text: [
      {
        contents: ['"Bar\'s closed, rooms are 10 gold a night."'],
      },
    ],
    options: [
      {
  ...
  }, // 6
  {
    ...
    text: [
      {
        content: ['You are given your room key and head upstairs.'],
      },
    ],
    options: [
      {
  ...
  }, // 7
  {
    ...
    text: [
      {
        content: ['You head upstairs to your room.'],
      },
    ],
    options: [
      {
  ...
  }, // 8
  {
    ...
    text: [
      ...
      {
        content: ['The counter is staffed by a night-shift worker.'],
        conditions: (player) => player.time.getHours() <= 6,
      },
    ],
    options: [
  ...
  }, // 9
  {
    ...
    text: [
      {
        content: ['You stand in your room at the inn.'],
      },
    ],
    options: [
      {
  ...
  }, // 10
  {
    ...
    text: [
      {
        content: ['You arrive at the outskirts of Ebonfront.'],
      },
      {
        content: [
        ...
        conditions: (player) =>
          player.time.getHours() >= 6 && player.time.getHours() <= 15,
      },
      {
        content: [
    ...
    options: [
      {
        ...
        alternate: ["You don't have enough gold to accept this offer."],
        action: function () {
          player.gold -= 20;
        },
        time: { day: 1, minute: 5 },
  ...
  }, // 14
  {
    ...
    text: [
      ...
      },
      {
        ...
        conditions: (player) =>
          player.time.getHours() >= 6 && player.time.getHours() <= 12,
        alternate: [
  ...
  }, // 19
  {
    ...
    text: [
      ...
      {
        content: ['You wander through the main streets of Timberside.'],
      },
      {
        content: [
  ...
  }, // 27
  {
    ...
    text: [
      {
        content: ["You stand inside Timberside's primary inn."],
      },
      {
        content: ['The innkeeper stands at the counter.'],
        conditions: (player) =>
    ...
    options: [
      {
        ...
        alternate: ['You do not have enough gold for a room.'],
  ...
  }, // 29
  {
    ...
    text: [
      {
        content: ['You are in your room at the Timberside inn.'],
      },
    ],
    options: [
      {
    ...
    options: [
      {
        ...
        time: { day: 5 },
        scene: 32,
        alternate: ['You do not have enough gold to join the caravan.'],
      },
      {
        text: 'Nevermind',
        scene: 15,
